...
public class NetworkTest {
 ...
 Session.REQUEST_TIMEOUT = 10000;
    ...
    public void testCase() throws Exception {
        ...
        System.err.println("------------------------------------------------[CLIENT]>putFile " + ui_client1.putFile(new File("../funz-client/src/main/resources/samples/novar.R"), new File("../funz-client/src/main/resources/samples/")));
